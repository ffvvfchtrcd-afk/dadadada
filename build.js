...
try {
  ...
  // 2. Instalar dependências da Loja (nexmarket)
  console.log('📦 Instalando dependências da Loja do Cliente (nexmarket)...');
  execSync('npm install', { cwd: path.join(__dirname, 'nexmarket'), stdio: 'inherit' });

  // 3. Build da Loja (nexmarket)
  ...
  // 4. Copiar os arquivos da loja (nexmarket/dist) diretamente para a raiz do dist
  ...
  // 5. Build do Painel Admin diretamente na pasta dist/admin/ (evita rename locks!)
  ...
  console.log('🔗 Loja (Cliente):  / (Principal)');
